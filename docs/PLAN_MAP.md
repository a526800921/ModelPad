...
| 计划 | 状态 | 当前阶段 | 依赖 | 证据 |
|---|---|---|---|---|
| [ModelPad v1 实施计划](plans/modelpad-v1.md) | 实施中 | 阶段 4：SwiftUI 主面板和菜单栏 | - | [阶段 1-3 证据](plans/modelpad-v1.md#阶段-3-完成证据) |
...
| modelpad-v1 | 阶段 3：本地 HTTP API | 新增 APIDTOs、APIServer（SwiftNIO）；全部测试通过（62 回归 + 21 新增，2026-07-01 UTC+8）。详见 [阶段 3 完成证据](plans/modelpad-v1.md#阶段-3-完成证据)。 |
